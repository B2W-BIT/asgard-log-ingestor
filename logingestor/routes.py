...
async def logger_function(logger, total_messages, **kwargs):
    await logger.info({
...
@app.route(conf.LOGS_QUEUE_NAMES, type=RouteTypes.AMQP_RABBITMQ, vhost=conf.RABBITMQ_VHOST, options = {Options.BULK_SIZE: conf.LOGS_BULK_SIZE})
