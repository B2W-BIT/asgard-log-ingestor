...
app = App(
    ...
    password=conf.RABBITMQ_PWD,
    prefetch_count=conf.RABBITMQ_PREFETCH,
)
...
@app.route(
    conf.LOGS_QUEUE_NAMES,
    vhost=conf.RABBITMQ_VHOST,
    options={Options.BULK_SIZE: conf.LOGS_BULK_SIZE},
)
