...
LOGS_QUEUE_NAMES = [
    item.strip() for item in os.getenv("LOGS_QUEUE_NAMES", "").split(",")
]
...
STATS_QUEUE_NAMES = [
    item.strip() for item in os.getenv("STATS_QUEUE_NAMES", "").split(",")
]
STATS_BULK_SIZE = int(os.getenv("STATS_BULK_SIZE", 1))
STATS_INDEX_PREFIX = os.getenv("STATS_INDEX_PREFIX", "asgard-app-stats")

FLUENTD_INDEXER_RABBITMQ_HOST = os.getenv(
    "FLUENTD_INDEXER_RABBITMQ_HOST", "127.0.0.1"
)
FLUENTD_INDEXER_RABBITMQ_USER = os.getenv(
    "FLUENTD_INDEXER_RABBITMQ_USER", "guest"
)
FLUENTD_INDEXER_RABBITMQ_PWD = os.getenv(
    "FLUENTD_INDEXER_RABBITMQ_PWD", "guest"
)
FLUENTD_INDEXER_RABBITMQ_PREFETCH = int(
    os.getenv("FLUENTD_INDEXER_RABBITMQ_PREFETCH", 32)
)
FLUENTD_INDEXER_RABBITMQ_VHOST = os.getenv(
    "FLUENTD_INDEXER_RABBITMQ_VHOST", "/"
)
FLUENTD_INDEXER_QUEUE_NAMES = [
    item.strip()
    for item in os.getenv("FLUENTD_INDEXER_QUEUE_NAMES", "").split(",")
]
