...
app = App(
    host=conf.FLUENTD_INDEXER_RABBITMQ_HOST,
...
@app.route(
    conf.FLUENTD_INDEXER_QUEUE_NAMES,
    vhost=conf.FLUENTD_INDEXER_RABBITMQ_VHOST,
    options={Options.BULK_SIZE: conf.FLUENTD_INDEXER_BULK_SIZE},
)
